...
func init() {
    configFile := filepath.Join(robots.Config.Directory, "pivotal.json")
    if _, err := os.Stat(configFile); err == nil {
        ...
        log.Printf("WARNING: Could not find configuration file pivotal.json in %s", robots.Config.Directory)
    }
